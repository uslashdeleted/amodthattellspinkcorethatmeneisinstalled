...
include $(CLEAR_VARS)
LOCAL_MODULE := amodthattellspinkcorethatmeneisinstalled
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -isystem'extern' -isystem'extern/libil2cpp/il2cpp/libil2cpp' -Wall -Wextra -DVERSION='"0.20.0"'
